...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspsaga.nvim', 'nvim-treesitter', 'Comment.nvim', 'null-ls.nvim', 'nvim-lspconfig', 'nvim-cmp', 'FixCursorHold.nvim', 'gitsigns.nvim', 'neoscroll.nvim', 'nvim-colorizer.lua', 'nvim-lsp-installer'}, { event = "BufRead *" }, _G.packer_plugins)]]
