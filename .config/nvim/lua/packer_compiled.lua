...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/shan/.local/share/nvim/site/pack/packer/start/catppuccin",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-cmp', 'nvim-colorizer.lua', 'null-ls.nvim', 'Comment.nvim', 'neoscroll.nvim', 'lspsaga.nvim', 'nvim-lsp-installer', 'FixCursorHold.nvim', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
