...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'lspsaga.nvim', 'nvim-cmp', 'neoscroll.nvim', 'null-ls.nvim', 'nvim-lsp-installer', 'nvim-colorizer.lua', 'Comment.nvim', 'nvim-lspconfig', 'FixCursorHold.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
