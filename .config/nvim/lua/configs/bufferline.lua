...
function M.config()
  ...
  bufferline.setup(require("core.utils").user_plugin_opts("plugins.bufferline", {
    ...
    highlights = {
      ...
      warning = {
        guifg = { attribute = "fg", highlight = "BufferLineWarning" },
        guibg = { attribute = "bg", highlight = "BufferLineWarning" },
      },
      warning_diagnostic = {
        guifg = { attribute = "fg", highlight = "BufferLineWarningDiagnostic" },
        guibg = { attribute = "bg", highlight = "BufferLineWarningDiagnostic" },
      },
